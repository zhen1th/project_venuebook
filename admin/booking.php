        ...
        <div class="row g-3">
            <div class="col-md-5">
                <div class="card p-3 venue-card mb-3" style="border:0;">
                    <img src="../assets/images/<?= htmlspecialchars($venue['gambar']) ?>" alt="gambar"
                        class="img-clickable" data-bs-toggle="modal" data-bs-target="#imgModal">
                    ...
                    <div class="mt-4">
                        <form method="POST" id="confirmForm">
                            ...
                            <div id="selectionBox" style="display:none"
                                class="d-flex gap-3 align-items-center bg-white p-3 border rounded shadow-sm">
                                <div>
                                ...
                                <div class="ms-auto d-flex gap-2">
                                    ...
                                    <button type="button" id="cancelSel"
